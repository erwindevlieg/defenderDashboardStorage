...
class TestGraphClient:
    ...
    @pytest.mark.asyncio
    async def test_fetch_secure_scores(self, mock_credential, sample_graph_secure_scores):
        ...
        with patch("aiohttp.ClientSession", return_value=AsyncMock(
            ...
            result = await client.fetch("https://graph.microsoft.com/v1.0/security/secureScores?$top=1")
